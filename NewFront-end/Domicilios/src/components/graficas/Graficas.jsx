...
const Graficas = () => {
  ...
  useEffect(() => {
    const obtenerEstadisticasIncidencias = async () => {
      try {
        const response = await fetch('http://192.168.1.100:3000/usuario/reportes/incidencias');
    ...
    const obtenerEstadisticasPedidos = async () => {
      try {
        const response = await fetch('http://192.168.1.100:3000/usuario/reportes/cantidad-pedidos');
        const result = await response.json();
    ...
    const obtenerEstadisticasRendimiento = async () => {
      try {
        const response = await fetch('http://192.168.1.100:3000/usuario/reportes/rendimiento-domiciliarios');
        const result = await response.json();
    ...
    const obtenerEstadisticasTiempoEntrega = async () => {
      try {
        const response = await fetch('http://192.168.1.100:3000/usuario/reportes/tiempo-promedio-entrega');
        const result = await response.json();
